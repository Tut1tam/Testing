...
class TestMatrix(unittest.TestCase):
    ...
    def test__normal_matrix(self):
        ...
        self.assertEqual(self.matrix.draw_matrix(), f'Ваша первая матрица:\n{mat1}\nВаша вторая матрица:\n{mat2}')
    ...
    def test__not_normal_matrix(self):
        ...
        self.assertEqual(self.matrix.draw_matrix(), f'Ваша первая матрица:\n{mat1}\nВаша вторая матрица:\n{mat2}')
        self.assertEqual(self.matrix.sum_matrix(), f'Матрицы должны быть одинаковых размеров, для того чтобы их можно было сложить!')
        self.assertEqual(self.matrix.dif_matrix(), f'Матрицы должны быть одинаковых размеров, для того чтобы их можно было вычесть!')
